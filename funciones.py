...
def posicion_k(θ1, θ2, θ3, k1x, k1y, k2x, k2y, k3):
...
def posicion(theta1, theta2, theta3):
    ...
    posicion_partial = partial(posicion_k, theta1, theta2, theta3, 1, 1, 1, 1, 1)

    return posicion_partial()



def H_k(θ1, θ2, θ3, k1x, k1y, k2x, k2y, k3):
...
def H(theta1, theta2, theta3):
    ...
    H_partial = partial(H_k, theta1, theta2, theta3, 1, 1, 1, 1, 1)
