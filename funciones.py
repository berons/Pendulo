...
def posicion_k(θ1, θ2, θ3, k1x, k1y, k2x, k2y, k3x, k3y):
    ...
    h_k = np.array([
        ...
        [-k1x*np.cos(θ1) - 0.05*k2x*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1)) + 0.5*k2y*(np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2))],
        [k1x*np.sin(θ1) - 0.05*k2x*(-np.sin(θ1)*np.sin(θ2) - np.cos(θ1)*np.cos(θ2)) + 0.9*k2y*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1))],
        [-k1x*np.cos(θ1) - 0.05*k2x*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1)) + 0.9*k2y*(np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2))],
        ...
        [-k1x*np.cos(θ1) + k2y*(np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2)) + 0.8*k3x*(-(np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.cos(θ1) + (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.sin(θ1)) - 0.05*k3y*((np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.sin(θ1) + (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.cos(θ1))],
        ],dtype=float)
...
def H_k(θ1, θ2, θ3, k1x, k1y, k2x, k2y, k3x, k3y):
    ...
    H = np.array([
        ...
        [k1x*np.sin(θ1) - 0.05*k2x*(np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2)) + 0.5*k2y*(-np.sin(θ1)*np.cos(θ2) + np.sin(θ2)*np.cos(θ1)), -0.05*k2x*(-np.sin(θ1)*np.sin(θ2) - np.cos(θ1)*np.cos(θ2)) + 0.5*k2y*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1)), 0, -np.cos(θ1), 0, -0.05*np.sin(θ1)*np.cos(θ2) + 0.05*np.sin(θ2)*np.cos(θ1), 0.5*np.sin(θ1)*np.sin(θ2) + 0.5*np.cos(θ1)*np.cos(θ2), 0, 0],
        ...
        [k1x*np.sin(θ1) - 0.05*k2x*(np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2)) + 0.9*k2y*(-np.sin(θ1)*np.cos(θ2) + np.sin(θ2)*np.cos(θ1)), -0.05*k2x*(-np.sin(θ1)*np.sin(θ2) - np.cos(θ1)*np.cos(θ2)) + 0.9*k2y*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1)), 0, -np.cos(θ1), 0, -0.05*np.sin(θ1)*np.cos(θ2) + 0.05*np.sin(θ2)*np.cos(θ1), 0.9*np.sin(θ1)*np.sin(θ2) + 0.9*np.cos(θ1)*np.cos(θ2), 0, 0],
        ...
        [k1x*np.sin(θ1) + k2y*(-np.sin(θ1)*np.cos(θ2) + np.sin(θ2)*np.cos(θ1)) + 0.8*k3x*(-(-np.sin(θ2)*np.sin(θ3) - np.cos(θ2)*np.cos(θ3))*np.sin(θ1) + (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.cos(θ1)) - 0.05*k3y*((np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.cos(θ1) - (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.sin(θ1)), k2y*(np.sin(θ1)*np.cos(θ2) - np.sin(θ2)*np.cos(θ1)) + 0.8*k3x*((-np.sin(θ2)*np.sin(θ3) - np.cos(θ2)*np.cos(θ3))*np.sin(θ1) + (np.sin(θ2)*np.cos(θ3) - np.sin(θ3)*np.cos(θ2))*np.cos(θ1)) - 0.05*k3y*((-np.sin(θ2)*np.sin(θ3) - np.cos(θ2)*np.cos(θ3))*np.cos(θ1) + (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.sin(θ1)), 0.8*k3x*((np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.sin(θ1) + (-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.cos(θ1)) - 0.05*k3y*((np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.cos(θ1) + (np.sin(θ2)*np.cos(θ3) - np.sin(θ3)*np.cos(θ2))*np.sin(θ1)), -np.cos(θ1), 0, 0, np.sin(θ1)*np.sin(θ2) + np.cos(θ1)*np.cos(θ2), 0.8*(-np.sin(θ2)*np.sin(θ3) - np.cos(θ2)*np.cos(θ3))*np.cos(θ1) + 0.8*(-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.sin(θ1), -0.05*(np.sin(θ2)*np.sin(θ3) + np.cos(θ2)*np.cos(θ3))*np.sin(θ1) - 0.05*(-np.sin(θ2)*np.cos(θ3) + np.sin(θ3)*np.cos(θ2))*np.cos(θ1)]
